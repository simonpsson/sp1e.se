...
check('Fredagsfett admin page uses 𓀂 chrome and links back to Kalender', /<title>𓀂 Admin<\/title>/.test(admin) && />Till kalendern<\/a>/.test(admin) && /href=["']\/fredagsfett\/kalender["']/.test(admin));
