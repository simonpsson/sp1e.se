...
Total Operating Expenses = SUM(FactExpenses[Amount])`,
    ...
    tags:           ["dax","revenue","kpi","hemfrid"],
  },
  {
    title:          "Intäkter Per Tjänstetyp",
    language:       "dax",
...
FIRSTNONBLANK(
  ...
  {
    title:          "Tidsintelligens — YoY / MoM / YTD",
    language:       "dax",
...
AVERAGEX(
    ...
    subcategory_id: "pb-orders",
    tags:           ["dax","orders","bookings","hemfrid"],
  },
  {
    title:          "Kundanalys — Grundläggande",
    language:       "dax",
...
Top 10% Revenue Share = DIVIDE([Top 10% Customer Revenue], [Total Revenue])`,
    description:    "Grundläggande intäktsmått: Total Revenue, AOV, Gross Margin, EBITDA, kostnader",
    subcategory_id: "pb-customers",
    tags:           ["dax","customers","retention","hemfrid"],
  },
  {
    title:          "Kundsegmentering & Riskanalys",
    language:       "dax",
...
DIVIDE([Total Orders], DISTINCTCOUNT(DimEmployee[TeamID]))`,
    ...
    subcategory_id: "pb-workforce",
    tags:           ["dax","workforce","operations","hemfrid"],
  },
  {
...
CALCULATE(
    ...
    subcategory_id: "pb-geo",
    tags:           ["dax","geographic","region","hemfrid"],
  },
  {
    title:          "RUT-specifika Measures",
    language:       "dax",
...
CALCULATE(
    ...
    subcategory_id: "pb-rut",
    tags:           ["dax","rut","rut-avdrag","hemfrid"],
  },
  {
    title:          "Säsong & Trendanalys",
    language:       "dax",
...
SWITCH(
    ...
    subcategory_id: "pb-seasonal",
    tags:           ["dax","seasonal","trend","hemfrid"],
  },
  {
...
DIVIDE(
    ...
    subcategory_id: "pb-marketing",
    tags:           ["dax","marketing","acquisition","hemfrid"],
  },
  {
    title:          "Kvalitet & Klagomål",
    language:       "dax",
...
[On Time Completion Rate] * 0.3`,
    ...
    subcategory_id: "pb-quality",
    tags:           ["dax","quality","complaints","hemfrid"],
  },
  {
...
DIVIDE(
    ...
    subcategory_id: "pb-forecast",
    tags:           ["dax","forecast","targets","hemfrid"],
  },
  {
...
DIVIDE([Total Revenue], [Best Month Ever])`,
    ...
    subcategory_id: "pb-ranking",
    tags:           ["dax","ranking","comparative","hemfrid"],
  },
  {
    title:          "Helper & Utility Measures",
    language:       "dax",
...
IF(ISBLANK([Total Revenue]), 0, [Total Revenue])`,
    ...
    subcategory_id: "pb-utility",
    tags:           ["dax","utility","helper","hemfrid"],
  }
];
